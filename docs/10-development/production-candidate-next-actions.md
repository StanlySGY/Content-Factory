...
| Agent Evaluation | LLM judge、billing-grade 成本结算、跨模型回归评测编排 | 当前已有人工/规则评价、默认关闭 deterministic regression evaluation runner、analytics API、tag-based 模型对比 API、provider metadata 成本归因校准 API 与只读 dashboard |
