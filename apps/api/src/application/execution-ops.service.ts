    ...
    const routes: ProductRouteReadinessItem[] = [
      ...
      },
      {
        ...
        deliveredCapabilities: [
          ...
          "billing-grade cost settlement ledger",
        ...
        safetyBoundaries: [
          ...
          "cost settlement uses explicit rate cards and persisted token usage without provider calls",
          "LLM judge calls run through execution job result ledger, secret injection, and provider quota gates",
          "cross-model regression creates isolated execution jobs and model-tagged evaluations",
