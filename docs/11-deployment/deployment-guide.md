...
| evaluation dashboard | Web `/evaluations` 只读展示 analytics、low-quality results 与 result evaluations，不触发 create/evaluate-rule/regression-run；deterministic regression evaluation runner 默认关闭且只做规则评价 |
