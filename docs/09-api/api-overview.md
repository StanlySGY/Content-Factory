...
| Knowledge/RAG Backend | `/api/knowledge/sources`、entries、archive/restore、keyword search、task candidates、`/api/knowledge/embedding-readiness`、本地 deterministic embedding snapshot、只读 candidate review UI | 真实 vector index、LLM rerank、context pack 自动刷新 |
