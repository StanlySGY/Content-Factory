...
| Agent Evaluation Backend | `/api/execution/results/:id/evaluations`、rule evaluation、`/api/execution/evaluations/regression-run`、analytics、low-quality list、`/api/execution/evaluations/model-comparison` tag-based 模型对比、只读 dashboard UI | LLM judge、真实成本归因、跨模型回归评测编排 |
